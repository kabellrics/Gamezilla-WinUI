...
public partial class SettingsViewModelOld : ObservableRecipient, INavigationAware
{
    ...
    public SettingsViewModelOld(IThemeSelectorService themeSelectorService, INavigationService navigationService, IPageSkinService pageSkinService,
        ISteamGameFinderService steamGameFinderService, IOriginGameFinderService originGameFinderService, IEpicGameFinderService epicGameFinderService,
    ...
    public async void OnNavigatedTo(object parameter)
    {
        try
        {
            ...
            //    ImportedStoreGames.Add(new ImportedGame(_steamGridDBService, epicgame));
            //var origingames = await _originGameFinderService.GetEADesktopGameAsync();
            //foreach (var origgame in origingames)
            //    ImportedStoreGames.Add(new ImportedGame(_steamGridDBService, origgame));
            //var steamgames = await _steamGameFinderService.GetSteamGameAsync();
            //foreach (var steamgame in steamgames)
            //    ImportedStoreGames.Add(new ImportedGame(_steamGridDBService, steamgame));
        }
        catch (Exception ex)
        {
            //throw;
